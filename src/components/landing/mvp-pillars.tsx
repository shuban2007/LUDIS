...
// MEDIUM MOTION: 4 cards stagger in with subtle fade+translate.
  ...
  return (
    <section id="capabilities" className="py-20 px-4 sm:px-6 max-w-7xl mx-auto border-t border-border-subtle relative">
      ...
      <StaggerContainer className="grid grid-cols-1 md:grid-cols-2 gap-6" stagger={0.08}>
        ...
        <StaggerItem>
          <div className="glass-standard glass-interactive rounded-3xl p-6 sm:p-8 border-border-default relative overflow-hidden flex flex-col justify-between h-full">
            <div>
