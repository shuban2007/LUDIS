    ...
    <section id="audience" className="py-28 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto border-t border-border-default select-none">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
        ...
        <ScrollReveal delay={0.05} duration={0.6} offset={20}>
          <div className="relative h-[480px] sm:h-[560px] rounded-lg overflow-hidden flex flex-col justify-end p-8 sm:p-12 border border-border-default hover:border-border-strong transition-colors duration-350 group cursor-pointer">
            ...
            />
            {/* Dark bottom gradient to ensure text readability on dark image overlay */}
    ...
    <section id="responsible-ai" className="py-24 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto border-t border-border-default text-center select-none">
      <ScrollReveal duration={0.5} offset={20}>
        <div className="space-y-6">
          <h2 className="text-sm font-serif tracking-[0.25em] text-foreground uppercase">
            DECISION SUPPORT. NOT MEDICAL DIAGNOSIS.
          </h2>
          <p className="text-sm sm:text-base text-foreground-secondary leading-relaxed max-w-2xl mx-auto font-normal">
    ...
    <section className="py-32 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto border-t border-border-default text-center relative overflow-hidden select-none">
      ...
      <ScrollReveal duration={0.6} offset={16}>
        <div className="max-w-2xl mx-auto space-y-6">
          <h2 className="text-4xl sm:text-6xl font-serif tracking-tight text-foreground">
            TRAIN WITH CLARITY.
          </h2>
          <p className="text-base sm:text-lg text-foreground-secondary max-w-md mx-auto leading-relaxed">
...
export function LandingFooter() {
  return (
    <footer className="py-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto border-t border-border-default text-xs text-foreground-muted select-none">
      <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-8">
        ...
        <div className="flex flex-wrap items-center gap-x-8 gap-y-3 text-foreground-secondary">
          <a href="#baseline" className="hover:text-brand transition-colors duration-150">Product</a>
          <a href="#baseline" className="hover:text-brand transition-colors duration-150">How it works</a>
          <a href="#audience" className="hover:text-brand transition-colors duration-150">Athletes</a>
          <a href="#audience" className="hover:text-brand transition-colors duration-150">Coaches</a>
          <a href="#responsible-ai" className="hover:text-brand transition-colors duration-150">Responsible AI</a>
        </div>
